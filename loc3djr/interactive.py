...
class Loc3DInterpreter(GTKInterpreter):
    """Threaded interpreter with loc3d support.
    ...
    def pre_interact(self):
        """Initialize loc3d before user interaction begins"""
...
if __name__ == '__main__':
    ...
    elif len(sys.argv) > 1 and sys.argv[1]=='-loc3djr':
        sys.argv = [sys.argv[0]]+sys.argv[2:]
        Loc3DInterpreter().mainloop()
    else:
